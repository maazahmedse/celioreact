                ...
                if (!li.classList.contains("disabled")) {
                    ...
                    if (navigation && navigation.classList.contains("navigation-accordion")) {
                        const siblings = Array.from(li.parentElement.children).filter(
                            (child) => child !== li && child.querySelector(".has-ul")
                        );
                ...
                <div className="sidebar-category sidebar-category-visible">
                    <div className="category-content no-padding">
                        <ul className="navigation navigation-main navigation-accordion">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="index.html" id="layout2">Layout 2 <span
                                        className="label bg-warning-400">Current</span></a></li>
                                    ...
                                    <li className="disabled"><a href="../../../layout_6/LTR/index.html"
                                        id="layout6">Layout 6 <span className="label label-transparent">Coming
                                            soon</span></a></li>
                                </ul>
                            </li>
                            <li>
                            ...
                            <!-- Forms --> */}
                            <li className="navigation-header"><span>Forms</span> <i className="icon-menu" title="Forms"></i>
                            </li>
                            <li>
                            ...
                            <!-- Appearance --> */}
                            <li className="navigation-header"><span>Appearance</span> <i className="icon-menu"
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="components_notifications_pnotify.html">PNotify notifications</a>
                                    </li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="animations_velocity_examples.html">Advanced examples</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                            ...
                            <!-- Layout --> */}
                            <li className="navigation-header"><span>Layout</span> <i className="icon-menu"
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            <li><a href="sidebar_double_collapse.html">Collapse main sidebar</a>
                                            </li>
                                            ...
                                            <li><a href="sidebar_double_visible.html">Opposite sidebar visible</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="sidebar_detached_sticky_custom.html">Sticky (custom
                                                scroll)</a></li>
                                            <li><a href="sidebar_detached_sticky_native.html">Sticky (native
                                                scroll)</a></li>
                                            <li><a href="sidebar_detached_separate.html">Separate categories</a>
                                            </li>
                                        </ul>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="navigation_vertical_disabled.html">Disabled navigation links</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="navigation_horizontal_disabled.html">Disabled navigation links</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            <li><a href="navbar_multiple_navbar_navbar.html">Navbar + navbar</a>
                                            </li>
                                            <li><a href="navbar_multiple_navbar_header.html">Navbar + header</a>
                                            </li>
                                            <li><a href="navbar_multiple_header_navbar.html">Header + navbar</a>
                                            </li>
                            ...
                            <!-- Data visualization --> */}
                            <li className="navigation-header"><span>Data visualization</span> <i className="icon-menu"
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <ul>
                                            <li><a href="dimple_lines_horizontal.html">Horizontal orientation</a>
                                            </li>
                                    ...
                                    <li>
                                        <a href="#">Bar charts</a>
                                        <ul>
                                            <li><a href="dimple_bars_horizontal.html">Horizontal orientation</a>
                                            </li>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            <li><a href="dimple_area_horizontal.html">Horizontal orientation</a>
                                            </li>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            <li><a href="dimple_step_horizontal.html">Horizontal orientation</a>
                                            </li>
                            ...
                            <!-- Extensions --> */}
                            <li className="navigation-header"><span>Extensions</span> <i className="icon-menu"
                            ...
                            <li>
                                ...
                                <ul>
                                    <li><a href="internationalization_switch_direct.html">Direct translation</a>
                                    </li>
                                    <li><a href="internationalization_switch_query.html">Querystring parameter</a>
                                    </li>
                                    <li><a href="internationalization_on_init.html">Set language on init</a></li>
                                    <li><a href="internationalization_after_init.html">Set language after init</a>
                                    </li>
                            ...
                            <!-- Tables --> */}
                            <li className="navigation-header"><span>Tables</span> <i className="icon-menu"
                                title="Tables"></i></li>
                            <li>
                            ...
                            <li>
                                <a href="#"><i className="icon-alignment-unalign"></i> <span>Data tables
                                    extensions</span></a>
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="datatable_extension_buttons_flash.html">Flash buttons</a>
                                            </li>
                                            <li><a href="datatable_extension_buttons_print.html">Print buttons</a>
                                            </li>
                                            <li><a href="datatable_extension_buttons_html5.html">HTML5 buttons</a>
                                            </li>
                                        </ul>
                                    </li>
                            ...
                            <!-- Page kits --> */}
                            <li className="navigation-header"><span>Page kits</span> <i className="icon-menu"
